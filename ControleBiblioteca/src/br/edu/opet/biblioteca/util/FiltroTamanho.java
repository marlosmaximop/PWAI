...
public class FiltroTamanho extends PlainDocument
{
    private static final long serialVersionUID = 1L;

    private int               mTamMaximo;

    public FiltroTamanho(int pTamMaximo)
    {
        this.mTamMaximo = pTamMaximo;
    ...
    private class FiltroInterno extends DocumentFilter
    {
        ...
        public void replace(FilterBypass pFiltro, int pDeslocamento, int pTamanho, String pTexto, AttributeSet pAtributos) throws BadLocationException
        {
            ...
            if (tTexto.length() > mTamMaximo)
                return;

            // Caso o tamanho e o tipo estejam certos, faz-se a alteração do texto no documento
